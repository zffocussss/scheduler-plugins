...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*GinoPvcArgs)(nil), (*config.GinoPvcArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta2_GinoPvcArgs_To_config_GinoPvcArgs(a.(*GinoPvcArgs), b.(*config.GinoPvcArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.GinoPvcArgs)(nil), (*GinoPvcArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_GinoPvcArgs_To_v1beta2_GinoPvcArgs(a.(*config.GinoPvcArgs), b.(*GinoPvcArgs), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta2_GinoPvcArgs_To_config_GinoPvcArgs(in *GinoPvcArgs, out *config.GinoPvcArgs, s conversion.Scope) error {
	out.EnvType = in.EnvType
	out.EnvName = in.EnvName
	return nil
}

// Convert_v1beta2_GinoPvcArgs_To_config_GinoPvcArgs is an autogenerated conversion function.
func Convert_v1beta2_GinoPvcArgs_To_config_GinoPvcArgs(in *GinoPvcArgs, out *config.GinoPvcArgs, s conversion.Scope) error {
	return autoConvert_v1beta2_GinoPvcArgs_To_config_GinoPvcArgs(in, out, s)
}

func autoConvert_config_GinoPvcArgs_To_v1beta2_GinoPvcArgs(in *config.GinoPvcArgs, out *GinoPvcArgs, s conversion.Scope) error {
	out.EnvType = in.EnvType
	out.EnvName = in.EnvName
	return nil
}

// Convert_config_GinoPvcArgs_To_v1beta2_GinoPvcArgs is an autogenerated conversion function.
func Convert_config_GinoPvcArgs_To_v1beta2_GinoPvcArgs(in *config.GinoPvcArgs, out *GinoPvcArgs, s conversion.Scope) error {
	return autoConvert_config_GinoPvcArgs_To_v1beta2_GinoPvcArgs(in, out, s)
}
